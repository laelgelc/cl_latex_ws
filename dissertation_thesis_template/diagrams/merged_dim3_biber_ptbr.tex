...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Dimensão 3 -- Referências Explícitas versus Referências Dependentes do Contexto \parencite[Original em língua inglesa]{biberVariationSpeechWriting1988}}
