...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Dimensão 2 -- Preocupações Narrativas versus Não Narrativas \parencite[Original em língua inglesa]{biberVariationSpeechWriting1988}}
    \label{fig:merged_dim2_biber_ptbr}
\end{figure}
