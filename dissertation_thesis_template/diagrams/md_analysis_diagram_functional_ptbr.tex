...
\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption{Análise Multidimensional Tradicional \parencite[Original em língua inglesa]{biberVariationSpeechWriting1988, biberDimensionsRegisterVariation1995}, \parencite{berbersardinhaMultidimensionalAnalysisResearch2019, berbersardinhaMultiDimensionalAnalysis252014}}
    \label{fig:traditional_md_analysis_ptbr}
\end{figure}
